...
save_kable(first_table, "first_table.tex")
writeLines(first_table, "first_table.tex")
...
save_kable(second_table, "second_table.tex")
writeLines(second_table, "second_table.tex")
