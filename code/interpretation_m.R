...
# -------------------------------
groups <- list(
  Non_PFL = subgroup_other_m,
  Large_States = subgroup_large_m,
  Neighbor_States = subgroup_neighbors_m
)

# Initialize output table
cohens_d_all <- data.frame(Outcome = names(subgroup_other_m))
